...
def main():
    global start_listener,main_window,current_key_stroke_listener,key_stroke_record,DELAY_entry,button_click
    ...
    #current_key_stroke_stop = tkinter.Label(main_window, text=f"YOUR CURRENT SHUTDOWN LISTENER KEYSTROKE: {str(exit_key)[1].upper()}",fg="white", bg="black", font=("13"))
    #current_key_stroke_stop.pack()
